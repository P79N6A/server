...
class E
  ...
  fn 'view/'+HTTP+'Response',->d,e{
    d['#'].do{|u|
      [u[Prev].do{|p|{_: :a, rel: :prev, href: p.uri, c: '&larr;',style: 'color:#ccc;font-size:2.4em;float:left;clear:both;margin-right:.2em'}},
       u[Next].do{|n|{_: :a, rel: :next, href: n.uri, c: '&rarr;',style: 'color:#ccc;font-size:2.4em;float:right;clear:both;'}},
