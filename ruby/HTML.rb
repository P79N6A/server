...
class WebResource
  module HTML
    ...
    include URIs
    InlineMeta = ['uri', Title, Image, Video, Abstract, From, To, Type, Content, Label, DC+'link', DC+'note', Atom+'link', RSS+'link', RSS+'guid', DC+'hasFormat', SIOC+'channel', SIOC+'attachment', SIOC+'user_agent', Stat+'contains']
