...
class R
  ...
  Gallery = -> graph,e,_=true {
    [{_: :style, c: R['/css/photo.css'].readFile},
     ...
     graph.keys.map{|i|
       {_: :a, class: :thumb, id: 'a'+rand.to_s.sha2[0..7], href: i.R.basename, c: {_: :img, src: i.R.thumbFile.basename}}},
     ...
     {_: :script, c: "
      var items = #{graph.keys.map{|k|{src: k.R.basename, msrc: k.R.thumbFile.basename, w: graph[k][Stat+'width'][0], h: graph[k][Stat+'height'][0]}}.to_json};
