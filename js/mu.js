...
E.on = function(b,f){
    this.addEventListener(b,f,false);return this};

E.click = function(f){
    this.on('click',f); return this};
...
E.attr = function(a,v){
    if(v){ this.setAttribute(a,String(v));return this
...
['attr','click','on','hide','show'].map(function(f){N[f]=function(){return this.map(E[f],arguments)}});
